...
/**
 * Created by st on 31/08/2017.
 */

public class Utils {
    DecimalFormat f = new DecimalFormat("##.00");
    public ElementoMenu[] listaBebidas,listaPlatos,listaPostre;
    ...
    public void iniciarListas(){
        ...
        listaPlatos[12]=new ElementoMenu(14,"Calamares",TipoBebida.PRINCIPAL);
    ...
    public ElementoMenu GetBebida(int i){
        return listaBebidas[i];
    }

    public ElementoMenu GetPlato(int i){
        return listaPlatos[i];
    }

    public ElementoMenu GetPostre(int i){
        return listaPostre[i];
    }
}
